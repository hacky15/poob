...
class TestCerebrasProvider:
    ...
    def test_creates_chat_model(self, mock_chat_cls, mock_detect):
        ...
        from poob.llm.cerebras_provider import CEREBRAS_BASE_URL, CerebrasProvider
    ...
    @patch("poob.llm.cerebras_provider._detect_best_model", return_value="qwen-3-235b-a22b-instruct-2507")
    @patch("poob.llm.cerebras_provider.ChatOpenAI")
    @patch("poob.llm.cerebras_provider._test_model", return_value=True)
    ...
    @patch("poob.llm.cerebras_provider._detect_best_model", return_value="llama3.1-8b")
    @patch("poob.llm.cerebras_provider.ChatOpenAI")
...
class TestDetectBestModel:
    ...
    def test_returns_preferred_when_it_works(self, mock_httpx, mock_test):
        ...
        from poob.llm.cerebras_provider import _detect_best_model
    ...
    @patch("poob.llm.cerebras_provider._test_model")
    @patch("poob.llm.cerebras_provider.httpx")
    ...
    @patch("poob.llm.cerebras_provider._test_model", return_value=False)
    @patch("poob.llm.cerebras_provider.httpx")
