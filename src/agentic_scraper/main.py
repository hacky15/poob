...
def _ensure_docker_services() -> None:
    ...
    """
    import importlib
    _log = importlib.import_module("agentic_scraper.utils.logging").get_logger("main.docker")
...
async def startup() -> None:
    ...
    if config.deal_radar_enabled:
        ...
        from agentic_scraper.quota.persistent_limiter import PersistentKV, build_quotas
        from agentic_scraper.resilience.circuit_breaker import breaker_registry
    ...
    if config.voice_enabled:
        ...
        from agentic_scraper.voice.audio_buffer import VADConfig
        from agentic_scraper.voice.fillers import FillerPlayer, generate_fillers
        from agentic_scraper.voice.session import VoiceSession
        from agentic_scraper.voice.stt import build_stt_cascade
        from agentic_scraper.voice.tts import build_tts_cascade
        from agentic_scraper.voice.voice_compat import apply_voice_compat_patches
