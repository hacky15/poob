...
if TYPE_CHECKING:
    ...
    from agentic_scraper.skills.web_search import SearchProviderCascade
...
class SmartDealRadar:
    ...
    def _vlm_to_deal(
        ...
        elif listing_price == 0 and has_price and vlm.estimated_value_mid > 0:
            # Explicitly free listing (price=0 was extracted, not defaulted)
            discount_pct = 100.0
