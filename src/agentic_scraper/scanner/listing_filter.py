...
from agentic_scraper.utils.geo import (
...
class FilterChain:
    ...
    def __init__(self, filters: list[SponsoredFilter | LocationTextFilter | CategoryFilter | FreshnessFilter | GeoDistanceFilter | GarbageFilter]) -> None:
