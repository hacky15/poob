...
from poob.sites.facebook.prompts import DETAIL_PROMPT, build_search_prompt
...
class FacebookMarketplaceAdapter:
    ...
    async def _get_details_direct(
        ...
        """
        from poob.browser.page_actions import extract_page_text, navigate_and_wait
        from poob.sites.facebook.extraction_prompts import (
