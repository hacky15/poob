...
from poob.skills.models import VisualEnrichment
...
if TYPE_CHECKING:
    ...
    from poob.quota.persistent_limiter import PersistentKV, PersistentQuota
    from poob.resilience.circuit_breaker import ServiceCircuitBreaker
...
class VisualEnrichmentService:
    ...
    async def enrich(self, image_url: str) -> VisualEnrichment:
        ...
        if image_bytes and self._cache:
            from poob.cache.hash_cache import compute_phash
